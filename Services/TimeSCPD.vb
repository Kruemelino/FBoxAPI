...
Friend Class TimeSCPD
    ...
    Private Property TR064Start As Func(Of SCPDFiles, String, Integer, Dictionary(Of String, String), Dictionary(Of String, String)) Implements ITimeSCPD.TR064Start
    Private ReadOnly Property ServiceFile As SCPDFiles = SCPDFiles.timeSCPD Implements ITimeSCPD.Servicefile
    Private ReadOnly Property ServiceID As Integer = 1 Implements ITimeSCPD.ServiceID
    ...
    Public Function SetConnectionRequestAuthentication(NTPServer1 As String, NTPServer2 As String) As Boolean Implements ITimeSCPD.SetNTPServers
        Return Not TR064Start(ServiceFile, "SetNTPServers", ServiceID,

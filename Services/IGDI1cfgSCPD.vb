...
''' </remarks> 
Public Class IGDI1cfgSCPD
    Implements IIGDI1cfgSCPD

    Public ReadOnly Property DocumentationDate As Date = New Date(2023, 1, 20) Implements IIGDI1cfgSCPD.DocumentationDate
    Private Property TR064Start As Func(Of SCPDFiles, String, Integer, Dictionary(Of String, String), Dictionary(Of String, String)) Implements IIGDI1cfgSCPD.TR064Start
    Private ReadOnly Property ServiceFile As SCPDFiles = SCPDFiles.igd1icfgSCPD Implements IIGDI1cfgSCPD.Servicefile
    Private ReadOnly Property ServiceID As Integer = 1 Implements IIGDI1cfgSCPD.ServiceID

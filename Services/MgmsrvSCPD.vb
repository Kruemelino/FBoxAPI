...
Friend Class MgmsrvSCPD
    ...
    Public Function SetManagementServerURL(URL As String) As Boolean Implements IMgmsrvSCPD.SetManagementServerURL
        Return Not TR064Start(ServiceFile, "SetManagementServerURL", New Dictionary(Of String, String) From {{"NewURL", URL}}).ContainsKey("Error")
    End Function
    ...
    Public Function SetManagementServerUsername(Username As String) As Boolean Implements IMgmsrvSCPD.SetManagementServerUsername
        Return Not TR064Start(ServiceFile, "SetManagementServerUsername", New Dictionary(Of String, String) From {{"NewUsername", Username}}).ContainsKey("Error")
    End Function
    ...
    Public Function SetManagementServerPassword(Password As String) As Boolean Implements IMgmsrvSCPD.SetManagementServerPassword
        Return Not TR064Start(ServiceFile, "SetManagementServerPassword", New Dictionary(Of String, String) From {{"NewPassword", Password}}).ContainsKey("Error")
    End Function
    ...
    Public Function SetConnectionRequestAuthentication(ConnectionRequestUsername As String, ConnectionRequestPassword As String) As Boolean Implements IMgmsrvSCPD.SetConnectionRequestAuthentication
        Return Not TR064Start(ServiceFile, "SetManagementServerPassword",
    ...
    Public Function SetUpgradeManagement(UpgradesManaged As Boolean) As Boolean Implements IMgmsrvSCPD.SetUpgradeManagement
        Return Not TR064Start(ServiceFile, "SetUpgradeManagement", New Dictionary(Of String, String) From {{"NewUpgradesManaged", UpgradesManaged.ToBoolStr}}).ContainsKey("Error")
    End Function

    Public Function SetTR069Enable(TR069Enabled As Boolean) As Boolean Implements IMgmsrvSCPD.SetTR069Enable
        Return Not TR064Start(ServiceFile, "NewTR069Enabled", New Dictionary(Of String, String) From {{"NewUpgradesManaged", TR069Enabled.ToBoolStr}}).ContainsKey("Error")
    End Function
    ...
    Public Function SetTR069FirmwareDownloadEnabled(TR069FirmwareDownloadEnabled As Boolean) As Boolean Implements IMgmsrvSCPD.SetTR069FirmwareDownloadEnabled
        Return Not TR064Start(ServiceFile, "X_AVM_DE_SetTR069FirmwareDownloadEnabled", New Dictionary(Of String, String) From {{"NewTR069FirmwareDownloadEnabled", TR069FirmwareDownloadEnabled.ToBoolStr}}).ContainsKey("Error")
    End Function
End Class

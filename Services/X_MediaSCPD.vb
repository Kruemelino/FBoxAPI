...
Friend Class X_MediaSCPD
    ...
    Private Property TR064Start As Func(Of SCPDFiles, String, Dictionary(Of String, String), Dictionary(Of String, String)) Implements IX_MediaSCPD.TR064Start
    ...
    Public Function GetDVBCEnable(ByRef DVBCEnabled As Boolean) As Boolean Implements IX_MediaSCPD.GetDVBCEnable
        Return TR064Start(ServiceFile, "GetDVBCEnable", Nothing).TryGetValueEx("NewDVBCEnabled", DVBCEnabled)
    End Function

    Public Function SetDVBCEnable(DVBCEnabled As Boolean) As Boolean Implements IX_MediaSCPD.SetDVBCEnable
        Return Not TR064Start(ServiceFile, "SetDVBCEnable", New Dictionary(Of String, String) From {{"NewDVBCEnabled", DVBCEnabled.ToBoolStr}}).ContainsKey("Error")
    End Function
    ...
    Public Function StationSearch(StationSearchMode As StationSearchModeEnum, ByRef StationSearchStatus As StationSearchStatusEnum) As Boolean Implements IX_MediaSCPD.StationSearch
        Return Not TR064Start(ServiceFile, "StationSearch", New Dictionary(Of String, String) From {{"NewStationSearchMode", StationSearchMode.ToString}}).TryGetValueEx("NewStationSearchStatus", StationSearchStatus)
    End Function
    ...
    Public Function GetSearchProgress(ByRef StationSearchStatus As StationSearchStatusEnum, ByRef SearchProgress As Integer) As Boolean Implements IX_MediaSCPD.GetSearchProgress
        With TR064Start(ServiceFile, "GetSearchProgress", Nothing)

...
Public Class IGDI1dslSCPD
    ...
    Private Property TR064Start As Func(Of SCPDFiles, String, Integer, Dictionary(Of String, String), Dictionary(Of String, String)) Implements IIGDI1dslSCPD.TR064Start
    Private ReadOnly Property ServiceFile As SCPDFiles = SCPDFiles.igd1dslSCPD Implements IIGDI1dslSCPD.Servicefile
    Private ReadOnly Property ServiceID As Integer = 1 Implements IIGDI1dslSCPD.ServiceID
